...
class Worker
{
    ...
    protected static function installSignal()
    {
        ...
        error_log("installSignal() forcibly terminated (avoid crash on HEROKU)", 0);
        return;
        ...
        // connection statusinstallSignal
    ...
    protected static function reinstallSignal()
    {
        ...
        error_log("reinstallSignal() forcibly terminated (avoid crash on HEROKU)", 0);
        return;
